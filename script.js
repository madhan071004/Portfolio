...
/* ============================================================
   TYPING ANIMATION
============================================================ */
const words = ['Java Full Stack Developer', 'Spring Boot Expert', 'React Developer', 'Software Engineer'];
let wordIndex  = 0;
let charIndex  = 0;
...
function getFilterKeyFromUrl() {
  const allowed = new Set(['all', 'java', 'web', 'sql']);
...
if (copyEmailBtn) {
  copyEmailBtn.addEventListener('click', async () => {
    const email = 'mmathanveeranam@gmail.com';
